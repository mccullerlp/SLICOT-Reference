...
C
C     MACPAR  (input)  REAL*10 array, dimension (5)
...
C     .. Array Arguments ..
      INTEGER           AMAP(*), S(*)
      REAL*10  A(LDA1,LDA2,*), CV(*), DWORK(*), MACPAR(*),
     $                  SV(*)
C     .. Local Scalars ..
      INTEGER           AI, I, PW, SCL
      REAL*10  A11, A12, A22, B11, B12, B22, BASE, CC, CL, CR,
