...
C             N >= 0.
C
C     A       (input) REAL*10 array, dimension (LDA,NA)
...
C
C     B       (input) REAL*10 array, dimension (LDB,NB)
...
C
C     C       (input) REAL*10 array, dimension (LDC,NA)
...
C     .. Array Arguments ..
      REAL*10  A(LDA,*), B(LDB,*), C(LDC,*), DWORK(*), H(LDH,*)
C     .. Local Scalars ..
