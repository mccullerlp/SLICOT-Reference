...
C
C     TA      (input/output)  REAL*10 array, dimension
C             (LDTA,M*K) / (LDTA,K)
...
C
C     T       (input)  REAL*10 array, dimension (LDT,N*K) /
C             (LDT,K)
...
C
C     G       (input/output)  REAL*10 array, dimension
C             (LDG,( N + M )*K) / (LDG,2*K)
...
C
C     L       (output)  REAL*10 array, dimension
C             (LDL,( N + M )*K) / (LDL,M*K)
...
C
C     CS      (input/output)  REAL*10 array, dimension (LCS)
