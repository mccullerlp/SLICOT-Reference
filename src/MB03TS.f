...
C
C     .. Parameters ..
      REAL*10   ZERO, HALF, ONE, TWO, THIRTY, FORTY
...
C     .. Array Arguments ..
      REAL*10   A(LDA,*), DWORK(*), G(LDG,*), U1(LDU1,*),
     $                   U2(LDU2,*)
C     .. Local Scalars ..
      LOGICAL            LBLK
      INTEGER            IERR, J2, J3, J4, K, ND
      REAL*10   A11, A22, A33, CS, DNORM, EPS, SCALE, SMLNUM,
     $                   SN, TAU, TAU1, TAU2, TEMP, THRESH, WI1, WI2,
     $                   WR1, WR2, XNORM
C     .. Local Arrays ..
      REAL*10   D(LDD,4), V(3), V1(3), V2(3), X(LDX,2)
