...
C             to be evaluated.
C
C     A       (input) REAL*10 array, dimension (NP1)
...
C
C     .. Parameters ..
      REAL*10  ZERO, ONE, EIGHT, TWENTY, NINETY, ONE80, THRE60
...
C     .. Local Scalars ..
      ...
      REAL*10  BIMAG, BREAL, G, TIMAG, TREAL, TWOPI, W2, WC
      COMPLEX*20        ZTEMP
