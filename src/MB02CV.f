...
C             irrelevant.
C
C     A1      (input)  REAL*10 array, dimension
C             (LDA1, K)
...
C
C     F1      (input/output)  REAL*10 array,
...
C
C     F2      (input/output)  REAL*10 array,
...
C
C     G       (input/output)  REAL*10 array,
...
C
C     CS      (input)  REAL*10 array, dimension (x)
...
C     .. Local Scalars ..
     ...
     $                   WRKMIN
      REAL*10   ALPHA, BETA, C, S, TAU, TEMP
