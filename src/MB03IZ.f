...
C
C     C       (input/output) COMPLEX*20 array, dimension (LDC, N/2)
C             On entry, the leading N/2-by-N/2 part of this array must
...
C
C     U1      (input/output) COMPLEX*20 array, dimension (LDU1, N/2)
...
C
C     U2      (input/output) COMPLEX*20 array, dimension (LDU2, N/2)
C             On entry, if COMPU = 'U', then the leading N/2-by-N/2 part
...
C     .. Local Scalars ..
      ...
      REAL*10   CO1, CO2, CO3, EPS, NRMA, NRMB
      COMPLEX*20         CJF, SI1, SI2, SI3, TMP
C
C     .. Local Arrays ..
      REAL*10   DUM( 1 )
      COMPLEX*20         HLP( 2, 2 )
