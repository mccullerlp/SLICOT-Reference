...
C
C     AV      (input) REAL*10 array, dimension (LDAV,NV)
...
C
C     BV      (input) REAL*10 array, dimension (LDBV,P)
...
C
C     CV      (input) REAL*10 array, dimension (LDCV,NV)
...
C
C     AW      (input) REAL*10 array, dimension (LDAW,NW)
...
C
C     BW      (input) REAL*10 array, dimension (LDBW,MW)
...
C
C     CW      (input) REAL*10 array, dimension (LDCW,NW)
...
C
C     DW      (input) REAL*10 array, dimension (LDDW,MW)
...
C             or (4). See METHOD.
C
C     S       (output) REAL*10 array, dimension (LDS,N)
...
C
C     R       (output) REAL*10 array, dimension (LDR,N)
C             The leading N-by-N upper triangular part of this array
...
C     .. Scalar Arguments ..
     ...
     $                 M, MW, N, NV, NW, P, PV
      REAL*10 ALPHAC, ALPHAO, SCALEC, SCALEO
C     .. Array Arguments ..
      REAL*10 A(LDA,*), AV(LDAV,*), AW(LDAW,*),
