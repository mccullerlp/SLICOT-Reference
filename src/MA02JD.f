      REAL*10 FUNCTION MA02JD( LTRAN1, LTRAN2, N, Q1, LDQ1, Q2,
     $                                  LDQ2, RES, LDRES )
C
C     PURPOSE
C
...
C
C     Q1      (input) REAL*10 array, dimension (LDQ1,N)
...
C
C     Q2      (input) REAL*10 array, dimension (LDQ2,N)
C             On entry, the leading N-by-N part of this array must
...
C     .. Array Arguments ..
      REAL*10  Q1(LDQ1,*), Q2(LDQ2,*), RES(LDRES,*)
C     .. Local Scalars ..
      INTEGER           I
      REAL*10  TEMP
C     .. Local Arrays ..
