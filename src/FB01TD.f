...
C              i+1
C
C     SINV    (input/output) REAL*10 array, dimension
C             (LDSINV,N)
...
C
C     AINV    (input) REAL*10 array, dimension (LDAINV,N)
C                                                                 -1
...
C
C     AINVB   (input) REAL*10 array, dimension (LDAINB,M)
C                                                                  -1
...
C
C     RINV    (input) REAL*10 array, dimension (LDRINV,*)
...
C
C     QINV    (input/output) REAL*10 array, dimension
C             (LDQINV,M)
...
C                                  i+1 i+1
C
C     RINVY   (input) REAL*10 array, dimension (P)
C                                      -1/2
...
C     .. Array Arguments ..
      INTEGER           IWORK(*)
      REAL*10  AINV(LDAINV,*), AINVB(LDAINB,*), C(LDC,*),
