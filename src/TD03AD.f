...
C             polynomial vectors over denominator polynomials.
C
C     DCOEFF  (input) REAL*10 array, dimension (LDDCOE,kdcoef),
...
C
C     UCOEFF  (input) REAL*10 array, dimension
...
C
C     B       (output) REAL*10 array, dimension (LDB,MAX(M,P))
...
C
C     D       (output) REAL*10 array, dimension (LDD,MAX(M,P))
