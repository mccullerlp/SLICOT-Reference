...
C
C     B       (input/output) REAL*10 array, dimension (NCONT)
...
C
C     WR      (input) REAL*10 array, dimension (NCONT)
C     WI      (input) REAL*10 array, dimension (NCONT)
...
C     .. Array Arguments ..
      REAL*10  A(LDA,*), B(*), DWORK(*), G(*), WI(*), WR(*),
     $                  Z(LDZ,*)
C     .. Local Scalars ..
      LOGICAL           COMPL
      INTEGER           I, IM1, K, L, LL, LP1, NCONT2, NI, NJ
      REAL*10  B1, P, Q, R, S, T
