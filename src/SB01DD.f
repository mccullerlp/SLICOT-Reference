...
C
C     WR      (input) REAL*10 array, dimension (N)
C     WI      (input) REAL*10 array, dimension (N)
...
C
C     Y       (input) REAL*10 array, dimension (M*N)
...
C     .. Local Scalars ..
     ...
     $                   MR1, NBLKCR, NC, NI, NJ, NP1, NR, NR1, RANK
      REAL*10   P, Q, R, S, SVLMXA, SVLMXB, TOLDEF
C     ..
C     .. Local Arrays ..
      REAL*10   SVAL( 3 )
C     ..
C     .. External Functions ..
      REAL*10   DASUM, DLAMCH, DLANGE, DLAPY2
