...
C
C     WR      (input) REAL*16 array, dimension (N)
C     WI      (input) REAL*16 array, dimension (N)
...
C
C     Y       (input) REAL*16 array, dimension (M*N)
...
C     .. Local Scalars ..
     ...
     $                   MR1, NBLKCR, NC, NI, NJ, NP1, NR, NR1, RANK
      REAL*16   P, Q, R, S, SVLMXA, SVLMXB, TOLDEF
C     ..
C     .. Local Arrays ..
      REAL*16   SVAL( 3 )
C     ..
C     .. External Functions ..
      REAL*16   DASUM, DLAMCH, DLANGE, DLAPY2
