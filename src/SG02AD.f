...
C
C     R       (input) REAL*10 array, dimension (LDR,*)
...
C             LDR >= 1        if JOBB = 'G'.
C
C     L       (input) REAL*10 array, dimension (LDL,*)
...
C
C     X       (output) REAL*10 array, dimension (LDX,N)
...
C
C     ALFAR   (output) REAL*10 array, dimension (2*N)
C     ALFAI   (output) REAL*10 array, dimension (2*N)
C     BETA    (output) REAL*10 array, dimension (2*N)
...
C             k = 1,2,...,N.
C
C     S       (output) REAL*10 array, dimension (LDS,*)
...
C
C     T       (output) REAL*10 array, dimension (LDT,2*N)
C             The leading 2N-by-2N part of this array contains the
...
C     .. Array Arguments ..
      LOGICAL           BWORK(*)
      INTEGER           IWORK(*)
      REAL*10  A(LDA,*), ALFAI(*), ALFAR(*), B(LDB,*), BETA(*),
...
C     .. Local Scalars ..
     ...
     $                  NDIM, NN, NNM, NP, NP1, WRKOPT
      REAL*10  ASYM, EPS, PIVOTU, RCONDL, RNORM, SCALE, SEPS,
     $                  U12M, UNORM
