...
C             LDE >= 1,        if JOBE = 'I'.
C
C     B       (input/output) COMPLEX*20 array, dimension (N)
...
C             first set to zero.
C
C     C       (input/output) COMPLEX*20 array, dimension
C             ((N-1)*INCC+1)
...
C
C     Q       (input/output) COMPLEX*20 array, dimension (LDQ,*)
...
C
C     Z       (input/output) COMPLEX*20 array, dimension (LDZ,*)
...
C     .. Array Arguments ..
      COMPLEX*20        A(LDA,*), B(*), C(*), E(LDE,*), Q(LDQ,*),
     $                  Z(LDZ,*)
C     .. Local Scalars ..
