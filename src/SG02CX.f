...
C                                                 JOBG = 'H'.
C
C     R       (input) REAL*10 array, dimension (LDR,N)
...
C
C     S       (input) REAL*10 array, dimension (LDS,*)
...
C
C     .. Parameters ..
      REAL*10  ZERO, ONE, TWO, THREE, FOUR, SIX
...
C     .. Scalar Arguments ..
      ...
      REAL*10  ALPHA, RNORM
C     .. Array Arguments ..
      REAL*10  DWORK(*), E(LDE,*), G(LDG,*), R(LDR,*), S(LDS,*)
C     .. Local Scalars ..
     ...
     $                  NN, NOPT, RPOS, SP
      REAL*10  BETA, DELTA, GAMMA, MX, PA, PB, PC, VNORM
C     .. Local Arrays ..
      REAL*10  CRD(2), CRN(2)
