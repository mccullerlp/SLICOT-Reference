...
C
C     A       (input) REAL*10 array, dimension (M*M*K)
...
C
C     B       (input) REAL*10 array, dimension (N*N*K)
...
C
C     C       (input/output) REAL*10 array, dimension (M*N*K)
...
C     .. Local Scalars ..
     ...
     $                   ZIS
      REAL*10   AC, AD, BETA, BIGNUM, DMIN, ELEM, SCALOC, SGN,
     $                   SPIV, TAU, TEMP
C     ..
