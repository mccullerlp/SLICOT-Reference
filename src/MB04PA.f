...
C
C     CS      (output) REAL*10 array, dimension (2*NB)
...
C     .. Local Scalars ..
      INTEGER           I, J, NB1, NB2
      REAL*10  AKI, ALPHA, C, S, TAUQ, TEMP, TTEMP
