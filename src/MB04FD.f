...
C             LDWORK >= MAX(3,N/2),        if JOB = 'E' and COMPQ = 'N';
...
C     V. Sima, Nov. 2009 (SLICOT version of the routine ZSHUTR).
C
C     REVISIONS
C
C     V. Sima, Dec. 2010, Jan. 2011, Aug. 2011, Aug. 2016, Sep. 2016,
C     Nov. 2016, Apr. 2020.
C     M. Voigt, Jan. 2012.
C
C     KEYWORDS
...
C     .. External Subroutines ..
     ...
     $                   DLARFG, DLARTG, DLAS2, DLASET, DLASSQ, DROT,
     $                   MA02PD, MB01LD, MB01MD, MB01ND, XERBLA
C
