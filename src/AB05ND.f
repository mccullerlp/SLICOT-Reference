...
C
C     B2      (input) REAL*10 array, dimension (LDB2,P1)
...
C             LDC2 >= 1 if N2 = 0.
C
C     D2      (input) REAL*10 array, dimension (LDD2,P1)
...
C
C     B       (output) REAL*10 array, dimension (LDB,M1)
...
C             LDC >= 1 if N1+N2 = 0.
C
C     D       (output) REAL*10 array, dimension (LDD,M1)
