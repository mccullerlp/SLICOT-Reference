...
C
C     A       (input/output) REAL*10 array, dimension (LDA,NCA)
C     E       (input/output) REAL*10 array, dimension (LDE,NCA)
...
C             s*E-A.
C
C     VEPS    (output) REAL*10 array, dimension (LDVEPS,ncv)
...
C     .. Array Arguments ..
      INTEGER           IMUK(*), INUK(*)
      REAL*10  A(LDA,*), E(LDE,*), VEPS(LDVEPS,*)
C     .. Local Scalars ..
