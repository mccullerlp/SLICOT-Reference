...
C
C     FPEAK   (input/output) REAL*10 array, dimension (2)
...
C             LDD >= 1,        if JOBD = 'Z'.
C
C     GPEAK   (output) REAL*10 array, dimension (2)
...
C     .. Parameters ..
      INTEGER            MAXIT
      PARAMETER          ( MAXIT = 30 )
      REAL*10   ZERO, ONE, TWO, FOUR, P25
      PARAMETER          ( ZERO = 0.0D+0, ONE = 1.0D+0, TWO = 2.0D+0,
     $                     FOUR = 4.0D+0, P25 = 0.25D+0 )
      REAL*10   TEN, HUNDRD, THOUSD
...
C     .. Local Scalars ..
     ...
     $                   NY, PM
      REAL*10   ANRM, ANRMTO, BIGNUM, BNORM, BOUND, CNORM,
...
C     .. External Functions ..
      REAL*10   AB13DX, DLAMCH, DLANGE, DLAPY2
      LOGICAL            LSAME
