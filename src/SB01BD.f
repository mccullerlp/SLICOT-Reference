...
C
C     WR,WI   (input/output) REAL*10 array, dimension (NP)
...
C     .. Scalar Arguments ..
     ...
     $                 NAP, NFP, NP, NUP
      REAL*10 ALPHA, TOL
C     .. Array Arguments ..
      REAL*10 A(LDA,*), B(LDB,*), DWORK(*), F(LDF,*),
     $                 WI(*), WR(*), Z(LDZ,*)
C     .. Local Scalars ..
     ...
     $                 NSUP, WRKOPT
      REAL*10 ANORM, BNORM, C, P, RMAX, S, X, Y, TOLER, TOLERB
C     .. Local Arrays ..
      LOGICAL          BWORK(1)
      REAL*10 A2(2,2)
