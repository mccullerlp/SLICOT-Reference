...
C
C     P1      (input) REAL*10 array, dimension (LDP11,LDP12,*)
...
C             LDP12 >= 1          if DP1 = -1.
C
C     P2      (input) REAL*10 array, dimension (LDP21,LDP22,*)
...
C             LDP22 >= 1          if DP2 = -1.
C
C     P3      (input/output) REAL*10 array, dimension
...
C     Workspace
C
C     DWORK   REAL*10 array, dimension (CP1)
C
C     Error Indicator
C
C     INFO    INTEGER
...
C     .. Scalar Arguments ..
     ...
     $                  LDP21, LDP22, LDP31, LDP32, RP1
      REAL*10  ALPHA
C     .. Array Arguments ..
      REAL*10  DWORK(*), P1(LDP11,LDP12,*), P2(LDP21,LDP22,*),
     $                  P3(LDP31,LDP32,*)
C     .. Local Scalars ..
      LOGICAL           CFZERO
