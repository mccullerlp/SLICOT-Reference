      REAL*10 FUNCTION MA02ID( TYP, NORM, N, A, LDA, QG,
     $                                  LDQG, DWORK )
C
C     PURPOSE
C
...
C
C     QG      (input) REAL*10 array, dimension (LDQG,N+1)
...
C     .. Scalar Arguments ..
      ...
      INTEGER            LDA, LDQG, N
C     .. Array Arguments ..
      REAL*10   A(LDA,*), DWORK(*), QG(LDQG,*)
C     .. Local Scalars ..
      LOGICAL            LSH
      INTEGER            I, J
      REAL*10   DSCL, DSUM, SCALE, SUM, TEMP, VALUE
