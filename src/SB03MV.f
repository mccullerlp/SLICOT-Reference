...
C
C     T       (input) REAL*10 array, dimension (LDT,2)
...
C
C     X       (output) REAL*10 array, dimension (LDX,2)
...
C     ..
C     .. Array Arguments ..
      REAL*10   B( LDB, * ), T( LDT, * ), X( LDX, * )
C     ..
C     .. Local Scalars ..
      INTEGER            I, IP, IPSV, J, JP, JPSV, K
      REAL*10   EPS, SMIN, SMLNUM, TEMP, XMAX
C     ..
C     .. Local Arrays ..
      INTEGER            JPIV( 3 )
      REAL*10   BTMP( 3 ), T9( 3, 3 ), TMP( 3 )
C     ..
