...
C
C     H       (input/output) REAL*10 array, dimension
C             (LDH1,LDH2,P)
...
C             LDH2 >= max(1,N).
C
C     Z       (input/output) REAL*10 array, dimension
C             (LDZ1,LDZ2,P)
...
C     .. Local Scalars ..
     ...
     $                  NH, NR, NROW, NZ
      REAL*10  AVE, CS, DISC, H11, H12, H21, H22, H33, H33S,
