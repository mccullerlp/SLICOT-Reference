...
C
C     Q2      (input/output) REAL*10 array, dimension (LDQ2, N)
...
C
C     U11     (input/output) REAL*10 array, dimension
C                            (LDU11, N/2)
...
C
C     U12     (input/output) REAL*10 array, dimension
C                            (LDU12, N/2)
C             On entry, if COMPU1 = 'U', then the leading N/2-by-N/2
...
C
C     U21     (input/output) REAL*10 array, dimension
C                            (LDU21, N/2)
...
C
C     U22     (input/output) REAL*10 array, dimension
C                            (LDU22, N/2)
C             On entry, if COMPU2 = 'U', then the leading N/2-by-N/2
C             part of this array must contain the upper right block of a
C             given matrix U02, and on exit, the leading N/2-by-N/2 part
...
C     .. Intrinsic Functions ..
      INTRINSIC          ABS, DBLE, DCMPLX, INT, MAX, MOD, SQRT,
     $                   IMAGPART
C
