...
C
C     S       (input/output) REAL*10 array, dimension (LDS,2)
...
C
C     R       (input/output) REAL*10 array, dimension (LDR,2)
...
C
C     A       (output) REAL*10 array, dimension (LDA,2)
...
C     .. Scalar Arguments ..
      ...
      REAL*10  SCALE
C     .. Array Arguments ..
      REAL*10  A(LDA,*), R(LDR,*), S(LDS,*)
C     .. Local Scalars ..
      REAL*10  ABSB, ABSG, ABST, ALPHA, BIGNUM, E1, E2, EPS,
     $                  ETA, P1, P3, P3I, P3R, S11, S12, S21, S22,
     $                  SCALOC, SGN, SMIN, SMLNUM, SNP, SNQ, SNT, TEMPI,
     $                  TEMPR, V1, V3
C     .. Local Arrays ..
      REAL*10  CSP(2), CSQ(2), CST(2), DELTA(2), DP(2), DT(2),
