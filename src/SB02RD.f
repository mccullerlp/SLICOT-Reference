...
C
C     V       (input or output) REAL*10 array, dimension
C             (LDV,N)
...
C
C     X       (input or output) REAL*10 array, dimension
C             (LDX,N)
...
C     .. Local Scalars ..
     ...
     $                  LWE, LWN, LWS, N2, NN, NP1, NROT
      REAL*10  GNORM, QNORM, PIVOTA, PIVOTU, RCONDA, RCONDU,
     $                  WRKOPT
