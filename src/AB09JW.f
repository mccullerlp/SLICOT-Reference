...
C
C     D       (input/output) REAL*10 array,
C             dimension (LDB,MAX(M,MW))
...
C
C     EW      (input/output) REAL*10 array, dimension (LDEW,NW)
...
C             LDEW >= 1,         if JOBEW = 'I'.
C
C     BW      (input/output) REAL*10 array,
...
C     V. Sima, Research Institute for Informatics, Bucharest, May 2010.
C
C     KEYWORDS
C
